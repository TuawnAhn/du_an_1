                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control"  name="ghi_chu" value="<?= $donhangs['ghi_chu'] ?>">
                                                            <span class="text-danger">
                                                            ...
                                                            <select class="form-select" name="trang_thai_don_hang_id">
                                                                ...
                                                                <?php
                                                                     if($donhangs['trang_thai_don_hang_id'] > $trangThai['id']  
                                                                        || $donhangs['trang_thai_don_hang_id'] == 8
                                                                        || $donhangs['trang_thai_don_hang_id'] == 9
                                                                        || $donhangs['trang_thai_don_hang_id'] == 10)
                                                                     {
                                                                        echo 'disabled';
                                                                     }
                                                                ?>
