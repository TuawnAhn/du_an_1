...
<head>
    ...
    <meta charset="utf-8" />
    <title>Danh sách Liên HỆ | NN Shop</title>
                            ...
                            <div class="h-100">
                                <div class="card">
                                    <div class="card-header align-items-center d-flex">
                                        <h4 class="card-title mb-0 flex-grow-1">Danh Sách Liên Hệ Sản Phẩm</h4>
                                        <a href="?act=form-them-lien-he" type="button" class="btn btn-soft-success material-shadow-none"><i class="ri-add-circle-line align-middle me-1"></i> THêm Liên HỆ</a>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($lienhes as $index => $lienHe) : ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php
                                                                    if ($lienHe['so_dien_thoai'] == 1) {
                                                                    ?>
                                                                        <span class="badge bg-success">hiển thị</span>
                                                                    <?php

                                                                    } else { ?>
                                                                        <span class="badge bg-success">không hiển thị</span>
                                                                    <?php
