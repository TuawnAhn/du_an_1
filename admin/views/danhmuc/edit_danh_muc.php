...
<head>
    ...
    <meta charset="utf-8" />
    <title>Cập nhật danh mục sản phẩm | Sliver Ring</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Nhập vào tên danh mục" name="ten_danh_muc" value="<?= $danhmuc['ten_danh_muc'] ?>">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-select" name="trang_thai">
                                                                ...
                                                                <option value="2" <?= $danhmuc['trang_thai'] == 2 ? 'selected' : '' ?>>Ẩn</option>
                                                            </select>
                                                            <span class="text-danger">
