...
.cart-table img {
    ...
    object-fit: cover; /* Cắt hoặc co dãn ảnh để vừa với khung */
}
...
.qty-control__number {
    width: 50px; /* Độ rộng ô nhập số lượng */
    text-align: center;
    margin: 0 5px; /* Khoảng cách giữa ô nhập và nút */
}
...
.btn-danger {
    background-color: #dc3545; /* Màu cho nút xóa */
    color: white;
    border: none;
    padding: 8px 12px;
    border-radius: 5px;
...
.btn-danger:hover {
    background-color: #c82333; /* Màu cho nút xóa khi hover */
}
  </style>
</main>
<br>
